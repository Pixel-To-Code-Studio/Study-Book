...
While following the curriculum that this study book follows there are several ways to ask for help:
...
Let’s take a classic example we often encounter while following the curriculum that this study book follows:
