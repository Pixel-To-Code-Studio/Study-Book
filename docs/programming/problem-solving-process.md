...
# Generic Top Tip for problem solving

Using the following mnemonic, **PRICET**, to give you a consistent approach to problem solving:

- **P**roblem definition - What is the problem you are trying to solve?
- **R**oot cause - determine the cause and other problems caused.
- **I**deas - Brainstorm ideas for possible solutions.
- **C**hoose - Decide on the best, feasible solution from your ideas.
- **E**xecute - Implement the chosen solution.
- **T**est - Gain feedback that the solution has resolved the problem.
