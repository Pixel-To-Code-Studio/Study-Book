...
It is a full command: declare a variable `s` and initialize it with `"WebDevStudent"`. JavaScript doesn't need any other information to know what we want. The statement is terminated with a semicolon.
...
{% ptc-youtube src="https://www.youtube.com/watch?v=WVyCrI1cHi8" %}