...
- **Pros**:
  ...
  - can be used to debug anything written in node.js, this will become especially important in the second half of the curriculum when you begin exploring the file system, databases and the backend.
- **Cons**:
